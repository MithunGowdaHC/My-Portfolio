...
export default function Home() {
  ...
  const projects = [
    ...
    },
    {
      ...
      link: "https://github.com/MithunGowdaHC/ENFTI",
    },
    {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/MithunGowdaHC", label: "GitHub" },
    { icon: Twitter, href: "https://x.com/MithunGowd34417", label: "Twitter" },
    {
      icon: Linkedin,
      href: "https://www.linkedin.com/in/mithungowda10/",
      label: "LinkedIn",
    },
    { icon: Mail, href: "mailto:mithungowdahc12a@gmail.com", label: "Email" },
  ];
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <Alert className="fixed bottom-4 right-4 w-auto bg-black/40 border-white/20 shadow-lg z-40">
        <AlertDescription className="text-white flex items-center gap-2">
          ...
          <motion.a
            href="https://x.com/MithunGowd34417"
            whileHover={{
              scale: 1.05,
          ...
          <div className="max-w-3xl mx-auto text-white">
            ...
            >
              ...
              <p className="font-mono text-gray-400 leading-relaxed text-sm">
                Hi, im Mithun, I am a fullstack developer from india. I build
                cool frontends and scalable backends i can also deploy them on
                internet. My interest also lies in AI.
                <br />
                Also i often contribute open source projects
              </p>
              <div className="mt-4">
                <GithubGraph
                  username="MithunGowdaHC"
                  blockMargin={1}
                  colorPallete={[
                    "#181818",
                    "#252525",
